class AboutsController < ApplicationController
  ...
  def index
    @abouts = About.all
    add_breadcrumb "List About", abouts_path
  end
  ...
  def show
    add_breadcrumb "List About", abouts_path
    add_breadcrumb "Show About", about_path(@about)
  end
  ...
  def new
    @about = About.new
    add_breadcrumb "List About", abouts_path
    add_breadcrumb "Create About", new_about_path
  end
  ...
  def edit
    add_breadcrumb "List About", abouts_path
    add_breadcrumb "Show About", about_path(@about)
    add_breadcrumb "Edit About", edit_about_path(@about)
  end
